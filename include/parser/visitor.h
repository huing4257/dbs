...
class Visitor: public SQLVisitor {
    ...
    std::any visitAlter_table_drop_foreign_key(SQLParser::Alter_table_drop_foreign_keyContext *context) override;
    std::any visitAlter_table_add_pk(SQLParser::Alter_table_add_pkContext *context) override;
    std::any visitAlter_table_add_foreign_key(SQLParser::Alter_table_add_foreign_keyContext *context) override;
